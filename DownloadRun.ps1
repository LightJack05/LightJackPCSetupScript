...
# Run this command:
# $Command = curl https://raw.githubusercontent.com/LightJack05/LightJackPCSetupScript/Windows-Terminal-Config/DownloadRun.ps1 -UseBasicParsing; Invoke-Expression $Command
...
curl https://raw.githubusercontent.com/LightJack05/LightJackPCSetupScript/Windows-Terminal-Config/main.ps1 -o $env:TEMP\SetupScript\main.ps1
curl https://raw.githubusercontent.com/LightJack05/LightJackPCSetupScript/Windows-Terminal-Config/setup.ps1 -o $env:TEMP\SetupScript\setup.ps1
curl https://raw.githubusercontent.com/LightJack05/LightJackPCSetupScript/Windows-Terminal-Config/RunMeAsAdmin.bat -o $env:TEMP\SetupScript\RunMeAsAdmin.bat
