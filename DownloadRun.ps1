...
# Run this command:
# $Command = curl https://raw.githubusercontent.com/LightJack05/LightJackPCSetupScript/LightJack-Surface/DownloadRun.ps1 -UseBasicParsing; Invoke-Expression $Command
...
curl https://raw.githubusercontent.com/LightJack05/LightJackPCSetupScript/LightJack-Surface/main.ps1 -o $env:TEMP\SetupScript\main.ps1
curl https://raw.githubusercontent.com/LightJack05/LightJackPCSetupScript/LightJack-Surface/setup.ps1 -o $env:TEMP\SetupScript\setup.ps1
curl https://raw.githubusercontent.com/LightJack05/LightJackPCSetupScript/LightJack-Surface/RunMeAsAdmin.bat -o $env:TEMP\SetupScript\RunMeAsAdmin.bat
