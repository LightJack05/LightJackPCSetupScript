...
function Main {
    ...
    if (!$OfflineMode) {
        if ($Software -or $All) {
            ...
            curl https://raw.githubusercontent.com/LightJack05/LightJackPCSetupScript/Vim-Development/winget.json -o $env:TEMP\SetupScript\winget.json
        }
        if ($PowerToysSettings -or $All) {
            ...
            curl https://raw.githubusercontent.com/LightJack05/LightJackPCSetupScript/Vim-Development/PowerToys.zip -o $env:TEMP\SetupScript\PowerToys.zip
        }
        ...
        if ($VisualStudio -or $All) {
            ...
            curl https://raw.githubusercontent.com/LightJack05/LightJackPCSetupScript/Vim-Development/.vsconfig -o $env:TEMP\SetupScript\.vsconfig
        }
        ...
        if ($WindowsTerminal -or $All) {
            ...
            curl https://raw.githubusercontent.com/LightJack05/LightJackPCSetupScript/Vim-Development/settings.json -o $env:TEMP\SetupScript\settings.json
        }
...
function StartSetup {
    ...
    & $env:TEMP\SetupScript\setup.ps1 -SAll:$All -SSoftware:$Software -SDiscord:$Discord -SPowerToysSettings:$PowerToysSettings -SVisualStudio:$VisualStudio -SUpdateStoreApps:$UpdateStoreApps -SDarkMode:$DarkMode -SRemoveBloat:$RemoveBloat -SShortcutCopying:$ShortcutCopying -SRestoreOldRightClickMenu:$RestoreOldRightClickMenu -SWindowsTerminal:$WindowsTerminal -SVimlark:$Vimlark -SOfflineMode:$OfflineMode -SCareless:$Careless
}
